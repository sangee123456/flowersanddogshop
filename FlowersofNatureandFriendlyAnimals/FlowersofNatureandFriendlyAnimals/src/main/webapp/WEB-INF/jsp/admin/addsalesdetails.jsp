...
<div class="container-fluid mt-3">
        ...
        <form action="/bookingsalesdetailsdb" method="post">
            <div style="text-align: center;">
              <h1> 
                  Add Sales Details</h1> 
                  ...
                  <div style="padding: 10px;">
                      <label>Name of the Sales Details:</label>
                      <input type="text" name="saledetails"> 
                  </div>
                  <div style="padding: 10px;">
                      <label>Needed count:</label>
                      <input type="text" name="neededcout"> 
                  </div>
